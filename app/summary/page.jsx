...
export default function SummaryPage() {
  ...
  const [paymentMode, setPaymentMode] = useState(""); // "cash" | "card" | "transfer"
  ...
  const submitOrder = async () => {
    try {
      ...
      // ✅ Normalize to backend schema (transfer → upi)
      ...
      const payload = {
        ...
        items,
        total,
        paymentMode: normalizedPM, // send normalized
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="bg-white/90 backdrop-blur rounded-2xl border border-gray-200 shadow-sm p-4 md:p-6">
            ...
            >
              ...
              <option value="transfer">Transfer</option>{/* will be saved as "upi" */}
            </select>
